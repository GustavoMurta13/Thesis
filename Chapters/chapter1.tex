...
\subsection{Video Analysis and Image Processing}
\subsection{Games}    
    The concept of games have been around for millenniums, and their origins are dated to the very birthplace of civilization - Ancient Mesopotamia. In the history of this civilization we can find the first ever example of a recorded game, the Royal Game of Ur.
    [Video games : an introduction to the industry / Andy Bossom and Ben Dunning.]

    The Royal Game of Ur consisted of a two-player game where each player races with their pieces from one end to the other over the twenty-square rectangular board. This game mirrors real-life events from its development, incorporating situations that occurred during its creation. The real-life scenarios depicted in the game continue to influence contemporary games, with current titles retaining the fundamental mechanics introduced by the original game. Although these mechanics have undergone updates, they still share the core principles established by the earlier game. [Royal Game of Ur Instructions]

    The civilization, since it's birth, have been growing and evolving but so did the games. The games matured to involve more complex mechanics, strategies and to use new technologies,such as wood, clay, rocks and finally computer technology.

    \subsubsection{Videogames}

    The Oxford English Dictionary defines the concept of Videogames as: "A game played by electronically manipulating images produced by a computer program on a monitor or other display". [Oxford English Dictionary]

    The origins of videogames are a convergence of various paths that lead to the concept that we know nowadays. The fathers that lead those paths were Steve Russel, Ralph Baer and Nolan Bushnell.
...
\section{State-of-the-Art}
\subsection{Video games analysis}  % resulting in the features analysis (visual, audio, overlay text) and tools integrated to the game engine (NVIDIA Highlights [GeForce Experience])
